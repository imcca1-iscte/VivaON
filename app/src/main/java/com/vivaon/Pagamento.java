...
public class Pagamento extends AppCompatActivity {
    ...
    public static final String clientKey = "ARuOnHMamOG1IeNsTmO98R-KO-RqmZ2ZOzkzxw1-SvTd81lVBORH_LBD0YjMpUfHdsxSKFzyS66Y5Qe3";
    ...
    private void getPayment() {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(amount)), "EUR", "Total:",
